...
# Render dà spesso "postgres://..." → servono gli adattamenti per SQLAlchemy:
...
def on_startup() -> None:
    # crea le tabelle se non esistono (evita crash al primo deploy)
